                ...
                <div class="post-box front-color">
                    ...
                    foreach ($post->comments as $comment)
                    {
                        ...
                        <div class="comment-box">
                            ...
                            <p class="comment-date">Commented at ' . $comment->comment_date . '' . (isset($comment->user) && isset($this->user) && strcmp($comment->user->user_name, $this->user->user_name) == 0 ? ' <a href="' . constant("URL") . 'dashboard/delete/' . $comment->comment_id . '">Delete</a>' : '') . '</p>
                        </div>
                        ';
                    }
